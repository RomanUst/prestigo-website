...
- **Status:** acknowledged
- **Note:** deferred at v2.1 milestone close 2026-08-25 — pre-existing `makeChainable()` test-mock issue, unrelated to any v2.1 change; tracked as tech debt for whoever next touches the POST handler test suite.
