...
Plans:
- [x] 19-01-PLAN.md — PATCH API handler with FSM validation + StatusBadge booking variants + unit tests
- [x] 19-02-PLAN.md — BookingsTable UI: status column, transition dropdown, operator notes textarea with auto-save
...
Plans:
- [x] 21-01-PLAN.md — Migration + types + isHolidayDate helper + applyGlobals update + admin API schema extension + tests
- [x] 21-02-PLAN.md — PricingForm UI: MIN FARE column + HOLIDAY DATES card + human verification
...
Plans:
- [x] 22-01-PLAN.md — Promo code DB claim function + admin API CRUD + admin page with table and form
- [x] 22-02-PLAN.md — Mobile admin: sidebar hamburger, 44px touch targets, bookings card layout, Promos nav
- [x] 22-03-PLAN.md — Booking wizard promo integration: Zustand store, validate-promo API, atomic claim in create-payment-intent, PromoInput UI
- [x] 22-04-PLAN.md — Full test suite + human verification of mobile admin and promo flows
