...
export const metadata: Metadata = {
  title: 'Prague to Paris Private Transfer — From €1,735',
  description: 'Book a private chauffeur from Prague to Paris. 1,050 km door-to-door in a Mercedes-Benz. Fixed price from €1,735, French capital.',
  alternates: { canonical: '/routes/prague-paris' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-paris',
    title: 'Prague to Paris Private Transfer — From €1,735',
    description: 'Book a private chauffeur from Prague to Paris. 1,050 km door-to-door in a Mercedes-Benz. Fixed price from €1,735, French capital.',
  },
}
...
const highlights = [
  ...
  { label: 'Price from', value: '€1,735', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,735', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €2,575', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,995', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Cologne or Reims stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Paris transfer take?', a: 'Approximately 10.5 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A3 northwest through Frankfurt and Cologne, crossing into Belgium near Aachen, then the E19/A1 southwest through Brussels to Paris.' },
  { q: 'Are there border crossings between Prague and Paris?', a: 'Yes. Czech-German Schengen at Waidhaus/Rozvadov, German-Belgian Schengen near Aachen, and Belgian-French Schengen south of Brussels. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Paris airports?', a: 'Yes. PRESTIGO serves both Paris Charles de Gaulle Airport (CDG) and Paris Orly Airport (ORY) directly with full meet-and-greet service and flight tracking.' },
  { q: 'Can I stop in Reims on the way?', a: 'Yes. Reims is on the route and available as an en-route stop — ideal for the champagne region before the final approach to Paris.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Paris route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Paris', item: 'https://rideprestigo.com/routes/prague-paris' },
  ],
}

export default function PragueParisPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Paris" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Paris</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Paris,<br /><span className="display-italic">City of Light.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>1,050 km west through Germany and Belgium to France's capital. The Eiffel Tower, the Louvre, the Champs-Élysées, and Charles de Gaulle — ten and a half hours, one fixed price, door to door.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Paris transfer crosses Germany and Belgium to deliver you to France's capital in comfort. Business meeting, Paris Fashion Week, or CDG Airport — your driver handles everything door to door.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Paris,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Reims (optional)', note: 'Champagne capital in the Marne — available as an en-route stop before the final drive into Paris.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Versailles, the Champagne route, or any stop along the western corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Paris', note: 'Drop-off at any Paris address, Charles de Gaulle Airport (CDG), Orly Airport (ORY), or your hotel in the arrondissements.', anchor: true, custom: false },
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossings', value: 'Czech-German Schengen at Waidhaus/Rozvadov. German-Belgian Schengen near Aachen. Belgian-French Schengen south of Brussels. No passport check for EU citizens.' },
                  ...
                  { label: 'Airport service', value: 'Full airport meet-and-greet at CDG and Orly. Flight tracking and flexible wait times included. Paris Le Bourget (LBG) available for private aviation.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Paris.<br /><span className="display-italic">From €1,735, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
