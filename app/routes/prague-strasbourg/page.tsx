...
export const metadata: Metadata = {
  title: 'Prague to Strasbourg Private Transfer — From €1,180',
  description: 'Book a private chauffeur from Prague to Strasbourg. 715 km door-to-door in a Mercedes-Benz. Fixed price from €1,180, Alsace European capital.',
  alternates: { canonical: '/routes/prague-strasbourg' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-strasbourg',
    title: 'Prague to Strasbourg Private Transfer — From €1,180',
    description: 'Book a private chauffeur from Prague to Strasbourg. 715 km door-to-door in a Mercedes-Benz. Fixed price from €1,180, Alsace European capital.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~715 km' },
  { label: 'Duration', value: '~7 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€1,180', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,180', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,750', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,360', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Stuttgart or Freiburg stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Strasbourg transfer take?', a: 'Approximately 7 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A5 south to Freiburg and the A35 northwest along the Rhine to Strasbourg.' },
  { q: 'Is there a border crossing between Prague and Strasbourg?', a: 'Yes. The Czech-German Schengen border is crossed at Waidhaus/Rozvadov. Strasbourg is in France — the German-French border is crossed near Kehl/Strasbourg. Both are Schengen, no passport check for EU citizens.' },
  { q: 'What institutions are based in Strasbourg?', a: 'Strasbourg is the seat of the European Parliament, the Council of Europe, and the European Court of Human Rights. It is a primary destination for EU institutional visits and MEP transfers.' },
  { q: 'Does PRESTIGO serve Strasbourg Airport (SXB)?', a: 'Yes. PRESTIGO serves Strasbourg Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, German motorway toll, French motorway toll (péage), fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Strasbourg route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Strasbourg', item: 'https://rideprestigo.com/routes/prague-strasbourg' },
  ],
}

export default function PragueStrasbourgPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Strasbourg" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Strasbourg</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Strasbourg,<br /><span className="display-italic">European capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>715 km southwest to the Rhine's Alsatian capital. The European Parliament, the Gothic cathedral, the Petite France quarter, and Alsatian wine country — seven hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Strasbourg transfer crosses Germany into France in comfort. European Parliament visit, EU institutional meeting, or an Alsatian cultural trip — your driver manages every kilometre.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Strasbourg,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Freiburg im Breisgau (optional)', note: 'Black Forest gateway city — available as an en-route stop before the Rhine crossing into Alsace.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'The Black Forest, the Alsatian wine route, or any stop along the Rhine corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Strasbourg', note: 'Drop-off at any Strasbourg address, Strasbourg Airport (SXB), the European Parliament, or the Grande Île old town.', anchor: true, custom: false },
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossings', value: 'Czech-German Schengen at Waidhaus/Rozvadov. German-French Schengen border at Kehl/Strasbourg. No passport check for EU citizens.' },
                  { label: 'Tolls', value: 'Czech motorway vignette, German motorway toll, and French péage all included in the quoted price.' },
                  { label: 'Return transfer', value: 'Book both directions together for a reduced rate.' },
                  { label: 'EU institutional visits', value: 'PRESTIGO serves the European Parliament, Council of Europe, and European Court of Human Rights directly for scheduled sessions and official visits.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Strasbourg.<br /><span className="display-italic">From €1,180, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
