...
export const metadata: Metadata = {
  title: 'Prague to Passau Private Transfer — From €365 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-passau',
    title: 'Prague to Passau Private Transfer — From €365 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Passau. 220 km door-to-door in a Mercedes-Benz. Fixed price from €365, Three Rivers City.',
  },
}
...
const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €365', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €540', photo: '/s-class-photo.png' },
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Passau" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
