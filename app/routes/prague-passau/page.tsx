...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Prague to Passau Chauffeur — From €${ePrice}`,
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Passau — private chauffeur transfer from Prague to Passau" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
