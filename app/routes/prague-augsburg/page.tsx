...
export const metadata: Metadata = {
  title: 'Prague to Augsburg Private Transfer — From €710',
  description: 'Book a private chauffeur from Prague to Augsburg. 430 km door-to-door in a Mercedes-Benz. Fixed price from €710, Bavaria\'s Roman city.',
  alternates: { canonical: '/routes/prague-augsburg' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-augsburg',
    title: 'Prague to Augsburg Private Transfer — From €710',
    description: 'Book a private chauffeur from Prague to Augsburg. 430 km door-to-door in a Mercedes-Benz. Fixed price from €710, Bavaria\'s Roman city.',
  },
}
...
const highlights = [
  ...
  { label: 'Price from', value: '€710', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €710', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,055', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €820', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Munich or Nuremberg stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Augsburg transfer take?', a: 'Approximately 4.5 hours via the D5 southwest through Plzeň and Nuremberg, then continuing south to Augsburg.' },
  { q: 'Is there a border crossing between Prague and Augsburg?', a: 'Yes. The Czech-German Schengen border is crossed at Waidhaus/Rozvadov. No passport check for EU citizens.' },
  { q: 'Is a same-day return available?', a: 'Yes. Your driver can wait in Augsburg or return at an agreed time. Book both directions together for a reduced rate.' },
  { q: 'What is Augsburg known for?', a: 'Augsburg is Germany\'s third oldest city — a Roman foundation with a Renaissance city hall, the Fugger banking dynasty\'s legacy, and one of Germany\'s most underappreciated old towns. 70 km from Munich.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Augsburg route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Augsburg', item: 'https://rideprestigo.com/routes/prague-augsburg' },
  ],
}

export default function PragueAugsburgPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Augsburg" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Augsburg</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Augsburg,<br /><span className="display-italic">Roman Bavaria.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>430 km southwest into one of Germany's oldest cities. The Fugger dynasty, a Renaissance Rathaus, and the Augsburg Water Management System (UNESCO) — four and a half hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Augsburg transfer runs the Bavarian route in comfort. Business visit, trade fair, or a southern Germany trip — your driver delivers you door to door.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Augsburg,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Nuremberg (optional)', note: 'Franconian capital — available as an en-route stop before continuing southwest to Augsburg.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'A stop anywhere along the Bavarian corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Augsburg', note: 'Drop-off at any Augsburg address, your hotel, or the old town centre.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Munich connection', value: 'Munich is 70 km from Augsburg. PRESTIGO can continue to Munich Airport (MUC) from Augsburg.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Augsburg.<br /><span className="display-italic">From €710, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
