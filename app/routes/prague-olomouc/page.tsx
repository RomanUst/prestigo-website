...
export const metadata: Metadata = {
  title: 'Prague to Olomouc Private Transfer — From €460 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-olomouc',
    title: 'Prague to Olomouc Private Transfer — From €460 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Olomouc. 280 km door-to-door in a Mercedes-Benz. Fixed price from €460, Moravia\'s historic capital.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Olomouc" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
