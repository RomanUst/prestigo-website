...
export const metadata: Metadata = {
  title: 'Prague to Kraków Private Transfer — From €635 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-krakow',
    title: 'Prague to Kraków Private Transfer — From €635 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Kraków. 385 km door-to-door in a Mercedes-Benz. Fixed price from €635, Poland\'s royal capital.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Kraków" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
