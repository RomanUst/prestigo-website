...
export const metadata: Metadata = {
  title: 'Prague to Hamburg Private Transfer — From €1,120',
  description: 'Book a private chauffeur from Prague to Hamburg. 680 km door-to-door in a Mercedes-Benz. Fixed price from €1,120, Germany\'s port city.',
  alternates: { canonical: '/routes/prague-hamburg' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-hamburg',
    title: 'Prague to Hamburg Private Transfer — From €1,120',
    description: 'Book a private chauffeur from Prague to Hamburg. 680 km door-to-door in a Mercedes-Benz. Fixed price from €1,120, Germany\'s port city.',
  },
}
...
const inclusions = [
  ...
  'Berlin or Dresden stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Hamburg transfer take?', a: 'Approximately 7 hours via the D8 north through Ústí nad Labem, crossing into Germany at Hřensko/Bad Schandau, then the A9 north through Berlin and the A7 to Hamburg.' },
  { q: 'Is there a border crossing between Prague and Hamburg?', a: 'Yes. The Czech-German Schengen border is crossed at Hřensko/Bad Schandau on the Elbe. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Hamburg Airport (HAM)?', a: 'Yes. PRESTIGO serves Hamburg Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'Can I stop in Berlin on the way?', a: 'Yes. Berlin is on the route and available as an en-route stop. Request at booking for optimal routing and timing.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Hamburg route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Hamburg', item: 'https://rideprestigo.com/routes/prague-hamburg' },
  ],
}

export default function PragueHamburgPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Hamburg" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Hamburg</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Hamburg,<br /><span className="display-italic">Germany's port city.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>680 km north through Saxony and Brandenburg to the Elbe estuary. The Speicherstadt, the Reeperbahn, the Alster, and one of Europe's busiest ports — seven hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Hamburg transfer runs north through Germany in comfort. Business visit, port logistics, or a northern Germany trip — your driver handles everything from pickup to drop-off.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Hamburg,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Berlin (optional)', note: 'German capital on the A9 — available as an en-route stop before continuing north to Hamburg.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Dresden, Saxon Switzerland, or any stop along the northern German corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Hamburg', note: 'Drop-off at any Hamburg address, Hamburg Airport (HAM), the Speicherstadt, or your hotel in the HafenCity.', anchor: true, custom: false },
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossing', value: 'Czech-German Schengen border at Hřensko/Bad Schandau on the Elbe. No passport check for EU citizens.' },
                  ...
                  { label: 'Airport service', value: 'Full airport meet-and-greet at Hamburg Airport (HAM). Flight tracking and flexible wait times included.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Hamburg.<br /><span className="display-italic">From €1,120, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
