...
export const metadata: Metadata = {
  title: 'Prague to Františkovy Lázně Private Transfer — From €290 | PRESTIGO',
  ...
  alternates: { canonical: '/routes/prague-frantiskovy-lazne' },
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-frantiskovy-lazne',
    title: 'Prague to Františkovy Lázně Private Transfer — From €290 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Františkovy Lázně. 175 km door-to-door in a Mercedes-Benz. Fixed price from €290, West Bohemia spa triangle.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Františkovy Lázně" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
