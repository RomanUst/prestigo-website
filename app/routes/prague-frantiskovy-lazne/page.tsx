...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Prague to Františkovy Lázně Chauffeur — From €${ePrice}`,
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Františkovy Lázně — private chauffeur transfer from Prague to Františkovy Lázně" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
