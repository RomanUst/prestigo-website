...
export const metadata: Metadata = {
  title: 'Prague to Bratislava Private Transfer — From €545 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-bratislava',
    title: 'Prague to Bratislava Private Transfer — From €545 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Bratislava. 330 km door-to-door in a Mercedes-Benz. Fixed price from €545, Slovakia\'s capital.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Bratislava" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
