...
export const metadata: Metadata = {
  title: 'Prague to Brussels Private Transfer — From €1,570',
  description: 'Book a private chauffeur from Prague to Brussels. 950 km door-to-door in a Mercedes-Benz. Fixed price from €1,570, EU institutional capital.',
  alternates: { canonical: '/routes/prague-brussels' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-brussels',
    title: 'Prague to Brussels Private Transfer — From €1,570',
    description: 'Book a private chauffeur from Prague to Brussels. 950 km door-to-door in a Mercedes-Benz. Fixed price from €1,570, EU institutional capital.',
  },
}
...
const highlights = [
  ...
  { label: 'Price from', value: '€1,570', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,570', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €2,330', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,805', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Cologne or Aachen stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Brussels transfer take?', a: 'Approximately 10 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A3 northwest through Frankfurt and Cologne, crossing into Belgium near Aachen, and continuing on the E40 to Brussels.' },
  { q: 'Are there border crossings between Prague and Brussels?', a: 'Yes. The Czech-German Schengen border at Waidhaus/Rozvadov and the German-Belgian Schengen border near Aachen. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Brussels Airport (BRU)?', a: 'Yes. PRESTIGO serves Brussels Airport and Brussels South Charleroi Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What EU institutions are based in Brussels?', a: 'Brussels hosts the European Commission, the European Council, the Council of the EU, NATO headquarters, and hundreds of EU agencies and lobby organisations. PRESTIGO serves the European Quarter and all major institutional addresses.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, German motorway toll, Belgian motorway toll (where applicable), fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Brussels route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Brussels', item: 'https://rideprestigo.com/routes/prague-brussels' },
  ],
}

export default function PragueBrusselsPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Brussels" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Brussels</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Brussels,<br /><span className="display-italic">capital of Europe.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>950 km northwest through Germany and into the heart of Europe. The European Commission, the Grand Place, NATO, and the Atomium — ten hours, one fixed price, door to door.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Brussels transfer crosses Germany and Belgium in comfort. EU institutional visit, NATO meeting, or a Belgian cultural trip — your driver manages every kilometre and crossing.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Brussels,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Cologne (optional)', note: 'Rhine cathedral city on the A3 — available as an en-route stop before the Belgian border at Aachen.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Aachen, Liège, or any stop along the western European corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Brussels', note: 'Drop-off at any Brussels address, Brussels Airport (BRU), the European Quarter, or your hotel in the Grand Place district.', anchor: true, custom: false },
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossings', value: 'Czech-German Schengen at Waidhaus/Rozvadov. German-Belgian Schengen near Aachen. No passport check for EU citizens.' },
                  { label: 'Tolls', value: 'Czech motorway vignette and German motorway toll included. Belgian heavy-vehicle tolls not applicable for passenger vehicles.' },
                  { label: 'Return transfer', value: 'Book both directions together for a reduced rate.' },
                  { label: 'EU Quarter service', value: 'PRESTIGO serves the Berlaymont, Schuman roundabout, NATO headquarters, and all Brussels institutional addresses directly.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Brussels.<br /><span className="display-italic">From €1,570, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
