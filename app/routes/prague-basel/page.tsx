...
export const metadata: Metadata = {
  title: 'Prague to Basel Private Transfer — From €1,120 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-basel',
    title: 'Prague to Basel Private Transfer — From €1,120 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Basel. 680 km door-to-door in a Mercedes-Benz. Fixed price from €1,120, Swiss Rhine city.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Basel" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
