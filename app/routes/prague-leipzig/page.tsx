...
const serviceSchema = {
  ...
  description: 'Chauffeured private transfer from Prague to Leipzig in Mercedes E-Class, S-Class, or V-Class. Fixed price, approximately 2 hours 15 minutes door-to-door via the D8, A17, and A14 motorways. Distance 165 km.',
  provider: {
    '@type': 'LocalBusiness',
