...
export const metadata: Metadata = {
  title: 'Prague to Leipzig Private Transfer — From €270 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-leipzig',
    title: 'Prague to Leipzig Private Transfer — From €270 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Leipzig. Door-to-door in a Mercedes-Benz. Fixed price from €270, Bach city and trade fair capital.',
  },
}
...
const inclusions = [
  ...
  'Dresden stopover available on request en route',
...
const faqs = [
  { q: 'How long does the Prague to Leipzig transfer take?', a: 'Approximately 2 hours via the D8 motorway north through the Czech Republic, crossing into Germany and continuing to Leipzig. The route is direct and well-maintained.' },
  { q: 'Is there a border crossing between Prague and Leipzig?', a: 'Yes. The Czech-German Schengen border is crossed at Hřensko/Bad Schandau. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Can I stop in Dresden on the way to Leipzig?', a: 'Yes. Dresden is on the route and available as an en-route stop. PRESTIGO can arrange a Dresden visit before continuing to Leipzig — just request at booking.' },
  { q: 'Is a same-day return available?', a: 'Yes. Your driver can wait in Leipzig or return at an agreed time. Book both directions together for a reduced rate.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Leipzig route.' },
]
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Leipzig" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Leipzig transfer connects you to Saxony's cultural and business capital. Trade fair visit, concert, or a weekend break — your driver delivers you door to door.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Dresden (optional)', note: 'Saxon capital on the Elbe — available as an en-route stop before continuing to Leipzig.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'A scenic break or any stop along the way. Your schedule, your pace.', anchor: false, custom: true },
                { city: 'Leipzig', note: 'Drop-off at any Leipzig address, your hotel, Messe Leipzig, or the city centre.', anchor: true, custom: false },
