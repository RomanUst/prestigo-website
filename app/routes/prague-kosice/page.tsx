...
export const metadata: Metadata = {
  title: 'Prague to Košice Private Transfer — From €955',
  description: 'Book a private chauffeur from Prague to Košice. 580 km door-to-door in a Mercedes-Benz. Fixed price from €955, Slovakia\'s eastern capital.',
  alternates: { canonical: '/routes/prague-kosice' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-kosice',
    title: 'Prague to Košice Private Transfer — From €955',
    description: 'Book a private chauffeur from Prague to Košice. 580 km door-to-door in a Mercedes-Benz. Fixed price from €955, Slovakia\'s eastern capital.',
  },
}
...
const highlights = [
  ...
  { label: 'Price from', value: '€955', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €955', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,420', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,100', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Bratislava or Banská Bystrica stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Košice transfer take?', a: 'Approximately 6 hours via the D1 east through Brno, continuing southeast through Slovakia via Bratislava and Banská Bystrica to Košice in the east of the country.' },
  { q: 'Is there a border crossing between Prague and Košice?', a: 'Yes. The Czech-Slovak Schengen border is crossed near Hodonín. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Košice Airport (KSC)?', a: 'Yes. PRESTIGO serves Košice International Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'Can I stop in Bratislava on the way?', a: 'Yes. Bratislava is on the route and available as an en-route stop — ideal for a business meeting or break before continuing east through Slovakia.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, Slovak motorway vignette, fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Košice route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Košice', item: 'https://rideprestigo.com/routes/prague-kosice' },
  ],
}

export default function PragueKosicePage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Košice" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Košice</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Košice,<br /><span className="display-italic">eastern Slovakia.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>580 km east through Moravia and across Slovakia to the Gothic cathedral city near the Hungarian border. St. Elisabeth Cathedral, the old town, and Slovakia's cultural second city — six hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Košice transfer crosses the Czech-Slovak border and travels the length of Slovakia in comfort. Business visit, cultural trip, or a return home — your driver delivers you door to door.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Košice,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Bratislava (optional)', note: 'Slovak capital directly on the D1 — available as an en-route stop before continuing east through the Slovak highlands.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Banská Bystrica, the High Tatras foothills, or any stop along the Slovak corridor. Your schedule, your pace.', anchor: false, custom: true },
                { city: 'Košice', note: 'Drop-off at any Košice address, Košice Airport (KSC), or the Gothic old town centre.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Tolls', value: 'Czech and Slovak motorway vignettes both included in the quoted price.' },
                  { label: 'Return transfer', value: 'Book both directions together for a reduced rate.' },
                  { label: 'Hungarian connection', value: 'Košice is 90 km from the Hungarian border. PRESTIGO can extend to Miskolc or Budapest from Košice on request.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Košice.<br /><span className="display-italic">From €955, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
