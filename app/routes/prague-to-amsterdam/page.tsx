...
export const metadata: Metadata = {
  title: 'Private Transfer Prague to Amsterdam — PRESTIGO Chauffeur',
  description: 'Long-distance private chauffeur transfer from Prague to Amsterdam. 915 km, approx 9.5 hours. Mercedes E, V, or S-Class. Quote on request.',
  alternates: {
    canonical: '/routes/prague-to-amsterdam',
    languages: {
      en: 'https://rideprestigo.com/routes/prague-to-amsterdam',
      'x-default': 'https://rideprestigo.com/routes/prague-to-amsterdam',
    },
  },
  robots: { index: false, follow: true },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-to-amsterdam',
    title: 'Private Transfer Prague to Amsterdam — PRESTIGO Chauffeur',
    description: 'Long-distance private transfer from Prague to Amsterdam. 915 km door-to-door in Mercedes. Quote on request.',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Amsterdam', item: 'https://rideprestigo.com/routes/prague-to-amsterdam' },
  ],
}

export default function PragueToAmsterdamPage() {
  return (
      ...
      <section className="bg-anthracite pt-32 pb-16 md:pt-40 md:pb-20 border-b border-anthracite-light">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <h1 className="display text-[36px] md:text-[52px] leading-tight">
            Prague to Amsterdam.<br />
            <span className="display-italic">Private chauffeur.</span>
          </h1>
          <div className="flex flex-wrap gap-8 mt-8">
            <div>
              <p className="label mb-1">Distance</p>
              <p className="font-body font-light text-[14px] text-offwhite">915 km</p>
            </div>
            <div>
              <p className="label mb-1">Duration</p>
              <p className="font-body font-light text-[14px] text-offwhite">approx. 9.5 hours</p>
            </div>
            <div>
              <p className="label mb-1">From</p>
              <p className="font-body font-light text-[14px]" style={{ color: 'var(--copper-light)' }}>€1,510 (E-Class)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-anthracite py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <p className="body-text text-[14px] mb-8" style={{ lineHeight: '1.9' }}>
            A 915-kilometre drive is not the typical PRESTIGO booking — most of our route pages cover destinations within a 5-hour radius of Prague. But our fleet is certified for international travel, our chauffeurs hold EU professional licences, and we run the Prague–Amsterdam route on request throughout the year.
          </p>
          ...
          <p className="body-text text-[13px] mb-6" style={{ lineHeight: '1.9' }}>
            Because 915 km is a 9.5-hour drive, every booking is priced and confirmed individually. The factors that change the final quote include:
          </p>
          <ul className="flex flex-col gap-4 mb-8">
            {[
              'Vehicle class. Indicative fares: from €1,510 in Mercedes E-Class, €1,960 in V-Class, or €2,265 in S-Class. Your actual quote depends on the specifics below.',
      ...
      <section className="bg-anthracite-mid py-16 border-t border-anthracite-light">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <h2 className="display text-[24px] md:text-[32px] mb-4">
            Get a quote for Prague to <span className="display-italic">Amsterdam.</span>
          </h2>
