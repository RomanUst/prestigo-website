...
export const metadata: Metadata = {
  title: 'Prague to Geneva Private Transfer — From €1,460',
  description: 'Book a private chauffeur from Prague to Geneva. 885 km door-to-door in a Mercedes-Benz. Fixed price from €1,460, Swiss diplomatic capital.',
  alternates: { canonical: '/routes/prague-geneva' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-geneva',
    title: 'Prague to Geneva Private Transfer — From €1,460',
    description: 'Book a private chauffeur from Prague to Geneva. 885 km door-to-door in a Mercedes-Benz. Fixed price from €1,460, Swiss diplomatic capital.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~885 km' },
  { label: 'Duration', value: '~9 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€1,460', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,460', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €2,170', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,680', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Bern or Basel stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Geneva transfer take?', a: 'Approximately 9 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then south through Stuttgart and Basel into Switzerland, continuing southwest to Geneva.' },
  { q: 'Are there border crossings between Prague and Geneva?', a: 'Yes. The Czech-German Schengen border at Waidhaus/Rozvadov and the German-Swiss non-Schengen border. Non-EU passengers require valid documents and may be subject to customs declaration.' },
  { q: 'Does PRESTIGO serve Geneva Airport (GVA)?', a: 'Yes. PRESTIGO serves Geneva International Airport directly with full meet-and-greet service and flight tracking. GVA also serves as a gateway for Chamonix and French Alps transfers.' },
  { q: 'What international organisations are based in Geneva?', a: 'Geneva hosts the UN European headquarters, the WHO, ICRC, WTO, WIPO, and over 200 intergovernmental organisations. PRESTIGO regularly serves diplomatic and institutional travellers.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, German motorway toll, Swiss motorway vignette (Vignette), fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Geneva route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Geneva', item: 'https://rideprestigo.com/routes/prague-geneva' },
  ],
}

export default function PragueGenevaPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Geneva" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Geneva</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Geneva,<br /><span className="display-italic">diplomatic capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>885 km southwest through Bavaria and across Switzerland to Lake Leman. The Jet d'Eau, the Palais des Nations, the watchmakers of the Rue du Rhône — nine hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Geneva transfer crosses Germany and Switzerland to Lake Leman in comfort. UN visit, private banking, or the Alps — your driver manages every kilometre and every border crossing.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Geneva,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Bern (optional)', note: 'Swiss federal capital 160 km northeast of Geneva — available as an en-route stop before continuing to Lake Leman.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Lausanne, Montreux, or any stop along the Swiss Riviera. Your route, your pace.', anchor: false, custom: true },
                { city: 'Geneva', note: 'Drop-off at any Geneva address, Geneva Airport (GVA), the Palais des Nations, or your hotel by the lake.', anchor: true, custom: false },
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossings', value: 'Czech-German Schengen border at Waidhaus/Rozvadov. German-Swiss non-Schengen border — valid documents required for non-EU passengers.' },
                  { label: 'Tolls', value: 'Czech motorway vignette, German motorway toll, and Swiss motorway vignette (Vignette) all included in the quoted price.' },
                  { label: 'Return transfer', value: 'Book both directions together for a reduced rate.' },
                  { label: 'French Alps connection', value: 'Chamonix is 80 km from Geneva, Annecy 40 km. PRESTIGO can extend your journey into France from Geneva Airport.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Geneva.<br /><span className="display-italic">From €1,460, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
