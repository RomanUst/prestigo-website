...
export const metadata: Metadata = {
  title: 'Prague to Liberec Private Chauffeur — From €175 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-liberec',
    title: 'Prague to Liberec Private Chauffeur — From €175 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Liberec. 105 km door-to-door in a Mercedes-Benz. Fixed price from €175, Jizera Mountains gateway.',
  },
}
...
const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €175', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €255', photo: '/s-class-photo.png' },
