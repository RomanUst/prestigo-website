...
const serviceSchema = {
  '@type': 'Service',
  '@id': 'https://rideprestigo.com/routes/prague-marianske-lazne#service',
  name: 'Private Chauffeur Transfer from Prague to Mariánské Lázně',
  serviceType: 'Private ground transfer',
  description: 'Chauffeured private transfer from Prague to Mariánské Lázně in Mercedes E-Class, S-Class, or V-Class. Fixed price, approximately 2 hours door-to-door via the D5 motorway and the R6. Distance 165 km.',
  provider: {
    '@type': 'LocalBusiness',
    ...
    itemListElement: [
      {
        ...
        url: 'https://rideprestigo.com/routes/prague-marianske-lazne#e-class',
      },
      {
        '@type': 'Offer',
        ...
        priceCurrency: 'EUR',
        availability: 'https://schema.org/InStock',
        url: 'https://rideprestigo.com/routes/prague-marianske-lazne#s-class',
      },
      {
        '@type': 'Offer',
        ...
        priceCurrency: 'EUR',
        availability: 'https://schema.org/InStock',
        url: 'https://rideprestigo.com/routes/prague-marianske-lazne#v-class',
      },
    ],
  },
}
...
export default function PragueMarianskeLaznePage() {
  return (
