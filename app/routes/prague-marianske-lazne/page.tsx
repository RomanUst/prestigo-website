...
export const metadata: Metadata = {
  title: 'Prague to Mariánské Lázně Private Transfer — From €270 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-marianske-lazne',
    title: 'Prague to Mariánské Lázně Private Transfer — From €270 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Mariánské Lázně. 165 km door-to-door in a Mercedes-Benz. Fixed price from €270, West Bohemia spa town.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Mariánské Lázně" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
