...
export const metadata: Metadata = {
  title: 'Prague to Bern Private Transfer — From €1,285',
  description: 'Book a private chauffeur from Prague to Bern. 780 km door-to-door in a Mercedes-Benz. Fixed price from €1,285, Swiss federal capital.',
  alternates: { canonical: '/routes/prague-bern' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-bern',
    title: 'Prague to Bern Private Transfer — From €1,285',
    description: 'Book a private chauffeur from Prague to Bern. 780 km door-to-door in a Mercedes-Benz. Fixed price from €1,285, Swiss federal capital.',
  },
}
...
const inclusions = [
  ...
  'Basel or Zurich stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Bern transfer take?', a: 'Approximately 8 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A5 south to Basel and the A1 southwest to Bern.' },
  { q: 'Are there border crossings between Prague and Bern?', a: 'Yes. The Czech-German Schengen border at Waidhaus/Rozvadov and the German-Swiss non-Schengen border at Basel. Non-EU passengers require valid documents and may be subject to customs declaration.' },
  { q: 'What is Bern known for?', a: 'Bern is the federal capital of Switzerland — home to the Swiss Federal Parliament, the UNESCO-listed medieval old town, the Zytglogge clock tower, and bear parks. It is a primary destination for diplomatic and governmental visits.' },
  { q: 'Does PRESTIGO serve Bern Airport (BRN)?', a: 'Yes. PRESTIGO serves Bern Airport directly, as well as Basel EuroAirport and Zurich Airport for onward connections.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Bern route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Bern', item: 'https://rideprestigo.com/routes/prague-bern' },
  ],
}

export default function PragueBernPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Bern" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Bern</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Bern,<br /><span className="display-italic">Swiss federal capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>780 km southwest through Bavaria and into the Swiss plateau. The medieval arcades, the Federal Parliament, the Zytglogge, and the Bernese Alps behind — eight hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Bern transfer crosses Germany into the Swiss plateau in comfort. Diplomatic visit, government meeting, or a Swiss Alps retreat — your driver handles every kilometre and border.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Bern,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Basel (optional)', note: 'Swiss Rhine city 100 km northeast of Bern — available as an en-route stop before continuing southwest to the capital.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Solothurn, the Bernese Mittelland, or any stop along the Swiss plateau. Your route, your pace.', anchor: false, custom: true },
                { city: 'Bern', note: 'Drop-off at any Bern address, the Federal Parliament, Bern Airport (BRN), or your hotel in the old town.', anchor: true, custom: false },
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossings', value: 'Czech-German Schengen border at Waidhaus/Rozvadov. German-Swiss non-Schengen border at Basel — valid documents required for non-EU passengers.' },
                  ...
                  { label: 'Geneva connection', value: 'Geneva is 160 km southwest of Bern. PRESTIGO can continue to Geneva Airport (GVA) from Bern.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Bern.<br /><span className="display-italic">From €1,285, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
