...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Prague to Brno Chauffeur — From €${ePrice}`,
    description: `Book a private chauffeur from Prague to Brno. 205 km on the D1 in a Mercedes-Benz. Fixed price from €${ePrice}, Moravia's capital. Tolls and vignette included.`,
    alternates: {
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Brno — private chauffeur transfer from Prague to Brno" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
