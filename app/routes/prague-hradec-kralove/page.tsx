...
export const metadata: Metadata = {
  title: 'Prague to Hradec Králové Private Transfer — From €190 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-hradec-kralove',
    title: 'Prague to Hradec Králové Private Transfer — From €190 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Hradec Králové. 115 km on the D11 in a Mercedes-Benz. Fixed price from €190.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Hradec Králové" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
