...
export const metadata: Metadata = {
  title: 'Prague to Zurich Private Transfer — From €1,140',
  description: 'Book a private chauffeur from Prague to Zurich. 690 km door-to-door in a Mercedes-Benz. Fixed price from €1,140, Swiss financial centre.',
  alternates: { canonical: '/routes/prague-zurich' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-zurich',
    title: 'Prague to Zurich Private Transfer — From €1,140',
    description: 'Book a private chauffeur from Prague to Zurich. 690 km door-to-door in a Mercedes-Benz. Fixed price from €1,140, Swiss financial centre.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~690 km' },
  { label: 'Duration', value: '~7 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€1,140', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,140', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,690', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,310', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Stuttgart or Basel stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Zurich transfer take?', a: 'Approximately 7 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A5 south to Basel and the A3 east to Zurich.' },
  { q: 'Are there border crossings between Prague and Zurich?', a: 'Yes. The Czech-German Schengen border at Waidhaus/Rozvadov and the German-Swiss non-Schengen border. Non-EU passengers require valid documents and may be subject to customs declaration.' },
  { q: 'Does PRESTIGO serve Zurich Airport (ZRH)?', a: 'Yes. PRESTIGO serves Zurich Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What is Zurich known for?', a: 'Zurich is Switzerland\'s financial and cultural capital — home to private banks, Bahnhofstrasse, the Kunsthaus art museum, and Lake Zurich. It regularly tops global quality-of-life rankings.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Zurich route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Zurich', item: 'https://rideprestigo.com/routes/prague-zurich' },
  ],
}

export default function PragueZurichPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Zurich" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Zurich</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Zurich,<br /><span className="display-italic">Swiss precision.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>690 km southwest through Bavaria and into Switzerland. Bahnhofstrasse, Lake Zurich, the Kunsthaus, and ZRH Airport — seven hours, one fixed price, door to door.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Zurich transfer crosses two borders into Switzerland in comfort. Private banking visit, corporate meeting, or a Swiss weekend — your driver handles every kilometre.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Zurich,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Basel (optional)', note: 'Swiss Rhine city at the three-country border — available as an en-route stop before continuing east to Zurich.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Baden, the Aargau vineyard region, or any stop along the Swiss plateau. Your route, your pace.', anchor: false, custom: true },
                { city: 'Zurich', note: 'Drop-off at any Zurich address, Zurich Airport (ZRH), Bahnhofstrasse, or your hotel by the lake.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Swiss onward', value: 'Bern is 125 km southwest, Geneva 290 km. PRESTIGO can extend your journey from Zurich to any Swiss city.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Zurich.<br /><span className="display-italic">From €1,140, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
