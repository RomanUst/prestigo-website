...
export const metadata: Metadata = {
  title: 'Private Transfer Prague to Milan — PRESTIGO Chauffeur',
  description: 'Long-distance private chauffeur transfer from Prague to Milan. 1,010 km, approx 11 hours. Mercedes E, V, or S-Class. Quote on request.',
  alternates: {
    canonical: '/routes/prague-to-milan',
    languages: {
      en: 'https://rideprestigo.com/routes/prague-to-milan',
      'x-default': 'https://rideprestigo.com/routes/prague-to-milan',
    },
  },
  robots: { index: false, follow: true },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-to-milan',
    title: 'Private Transfer Prague to Milan — PRESTIGO Chauffeur',
    description: 'Long-distance private transfer from Prague to Milan. 1,010 km door-to-door in Mercedes. Quote on request.',
  },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Milan', item: 'https://rideprestigo.com/routes/prague-to-milan' },
  ],
}

export default function PragueToMilanPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-wrap gap-8 mt-8">
            <div>
              ...
              <p className="font-body font-light text-[14px] text-offwhite">1,010 km</p>
            </div>
            <div>
              <p className="label mb-1">Duration</p>
              <p className="font-body font-light text-[14px] text-offwhite">approx. 11 hours</p>
            </div>
            <div>
              <p className="label mb-1">From</p>
              <p className="font-body font-light text-[14px]" style={{ color: 'var(--copper-light)' }}>€1,665 (E-Class)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-anthracite py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <p className="body-text text-[14px] mb-8" style={{ lineHeight: '1.9' }}>
            A 1,010-kilometre drive is not the typical PRESTIGO booking — most of our route pages cover destinations within a 5-hour radius of Prague. But our fleet is certified for international travel, our chauffeurs hold EU professional licences, and we run the Prague–Milan route on request throughout the year.
          </p>
          ...
          <p className="body-text text-[13px] mb-6" style={{ lineHeight: '1.9' }}>
            Because 1,010 km is a 11-hour drive, every booking is priced and confirmed individually. The factors that change the final quote include:
          </p>
          <ul className="flex flex-col gap-4 mb-8">
            {[
              'Vehicle class. Indicative fares: from €1,665 in Mercedes E-Class, €2,165 in V-Class, or €2,500 in S-Class. Your actual quote depends on the specifics below.',
      ...
      <section className="bg-anthracite-mid py-16 border-t border-anthracite-light">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <h2 className="display text-[24px] md:text-[32px] mb-4">
            Get a quote for Prague to <span className="display-italic">Milan.</span>
          </h2>
