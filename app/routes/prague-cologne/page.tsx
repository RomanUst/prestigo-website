...
export const metadata: Metadata = {
  title: 'Prague to Cologne Private Transfer — From €1,005',
  description: 'Book a private chauffeur from Prague to Cologne. 610 km door-to-door in a Mercedes-Benz. Fixed price from €1,005, Rhine cathedral city.',
  alternates: { canonical: '/routes/prague-cologne' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-cologne',
    title: 'Prague to Cologne Private Transfer — From €1,005',
    description: 'Book a private chauffeur from Prague to Cologne. 610 km door-to-door in a Mercedes-Benz. Fixed price from €1,005, Rhine cathedral city.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~610 km' },
  { label: 'Duration', value: '~6 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€1,005', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,005', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,495', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,160', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Frankfurt or Dortmund stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Cologne transfer take?', a: 'Approximately 6 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A9 north to Frankfurt and the A3/A4 west to Cologne.' },
  { q: 'Is there a border crossing between Prague and Cologne?', a: 'Yes. The Czech-German Schengen border is crossed at Waidhaus/Rozvadov. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Cologne Bonn Airport (CGN)?', a: 'Yes. PRESTIGO serves Cologne Bonn Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What trade fairs does PRESTIGO serve at Cologne?', a: 'Cologne hosts Anuga, Cologne Furniture Fair (imm), Art Cologne, and the Photokina. PRESTIGO can deliver you directly to Koelnmesse for any major trade event.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Cologne route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Cologne', item: 'https://rideprestigo.com/routes/prague-cologne' },
  ],
}

export default function PragueColognePage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Cologne" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Cologne</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Cologne,<br /><span className="display-italic">Rhine cathedral city.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>610 km west through Bavaria and into the Rhine metropolis. Cologne Cathedral, the old town, Koelnmesse trade fairs, and the river — six hours, one fixed price, door to door.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Cologne transfer covers the western German corridor in comfort. Trade fair, business meeting, or a Rhine weekend — your driver delivers you door to door.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Cologne,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Frankfurt (optional)', note: 'Germany\'s financial capital on the A3 — available as an en-route stop before continuing northwest to Cologne.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'The Westerwald, the Rhine Gorge, or any stop along the western German corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Cologne', note: 'Drop-off at any Cologne address, Cologne Bonn Airport (CGN), Koelnmesse, or your hotel by the Cathedral.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Düsseldorf connection', value: 'Düsseldorf is 45 km north of Cologne. PRESTIGO can extend to Düsseldorf Airport (DUS) from Cologne.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Cologne.<br /><span className="display-italic">From €1,005, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
