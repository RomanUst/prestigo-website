...
export const metadata: Metadata = {
  title: 'Prague to Pardubice Private Transfer — From €180 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-pardubice',
    title: 'Prague to Pardubice Private Transfer — From €180 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Pardubice. 110 km on the D11 in a Mercedes-Benz. Fixed price from €180, East Bohemia door-to-door.',
  },
}
...
const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €180', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €270', photo: '/s-class-photo.png' },
    ...
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0">
          <img src="/photohero.png" alt="Pardubice" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {vehicles.map((v) => (
              <div key={v.name} className="border border-anthracite-light flex flex-col">
                <div className="w-full overflow-hidden" style={{ aspectRatio: '16/9' }}><img src={v.photo} alt={v.name} className="w-full h-full object-cover" style={{ filter: 'brightness(0.92)' }} /></div>
