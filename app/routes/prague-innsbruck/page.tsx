...
export const metadata: Metadata = {
  title: 'Prague to Innsbruck Private Transfer — From €900',
  description: 'Book a private chauffeur from Prague to Innsbruck. 545 km door-to-door in a Mercedes-Benz. Fixed price from €900, Tyrolean capital.',
  alternates: { canonical: '/routes/prague-innsbruck' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-innsbruck',
    title: 'Prague to Innsbruck Private Transfer — From €900',
    description: 'Book a private chauffeur from Prague to Innsbruck. 545 km door-to-door in a Mercedes-Benz. Fixed price from €900, Tyrolean capital.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~545 km' },
  { label: 'Duration', value: '~5.5 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€900', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €900', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,335', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,035', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Salzburg or Linz stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Innsbruck transfer take?', a: 'Approximately 5.5 hours via the D3 south through South Bohemia, crossing into Austria, then south through Salzburg and west through the Tyrolean Alps to Innsbruck.' },
  { q: 'Is there a border crossing between Prague and Innsbruck?', a: 'Yes. The Czech-Austrian Schengen border is crossed in South Bohemia. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Innsbruck Airport (INN)?', a: 'Yes. PRESTIGO serves Innsbruck Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'Can I stop in Salzburg on the way?', a: 'Yes. Salzburg is on the route and available as an en-route stop. Request at booking for optimal routing.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, Austrian motorway vignette, Brenner motorway toll (if applicable), fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Innsbruck route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Innsbruck', item: 'https://rideprestigo.com/routes/prague-innsbruck' },
  ],
}

export default function PragueInnsbruckPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Innsbruck" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Innsbruck</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Innsbruck,<br /><span className="display-italic">Tyrolean capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>545 km south through Bohemia, Austria, and into the Tyrolean Alps. The Golden Roof, the Inn valley, ski resorts above the city, and alpine air — five and a half hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Innsbruck transfer delivers you to Tyrol in comfort. Ski season, business visit, or an alpine retreat — your driver handles everything from pickup to drop-off.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Innsbruck,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Salzburg (optional)', note: 'Mozart\'s city on the way into Tyrol — available as an en-route stop before the alpine descent to Innsbruck.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'A stop at any Austrian village or alpine resort along the way. Your route, your pace.', anchor: false, custom: true },
                { city: 'Innsbruck', note: 'Drop-off at any Innsbruck address, Innsbruck Airport (INN), or your ski resort in the Tyrolean Alps.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Tolls', value: 'Czech and Austrian motorway vignettes included. Tyrolean motorway tolls included in the quoted price.' },
                  { label: 'Return transfer', value: 'Book both directions together for a reduced rate.' },
                  { label: 'Ski transfers', value: 'PRESTIGO serves all major Tyrolean ski resorts from Innsbruck — Kitzbühel, St. Anton, and the Ötztal Valley on request.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Innsbruck.<br /><span className="display-italic">From €900, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
