...
export const metadata: Metadata = {
  title: 'Prague to Budapest Private Transfer — From €885 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-budapest',
    title: 'Prague to Budapest Private Transfer — From €885 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Budapest. 535 km door-to-door in a Mercedes-Benz. Fixed price from €885, Pearl of the Danube.',
  },
}
...
const inclusions = [
  ...
  'Bratislava stop available on request en route',
...
const faqs = [
  { q: 'How long does the Prague to Budapest transfer take?', a: 'Approximately 5.5 hours via the D1 east to Brno, then south through Bratislava and across the Slovak-Hungarian border into Budapest.' },
  { q: 'Are there border crossings between Prague and Budapest?', a: 'Yes. The Czech-Slovak Schengen border near Hodonín and the Slovak-Hungarian Schengen border near Rajka/Győr. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Can I stop in Bratislava on the way?', a: 'Yes. Bratislava is directly on the route. An en-route stop is available on request — ideal for a lunch break or a short city visit.' },
  { q: 'Does PRESTIGO serve Budapest Airport (BUD)?', a: 'Yes. PRESTIGO serves Budapest Ferenc Liszt International Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, Slovak motorway vignette, Hungarian motorway vignette, fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Budapest route.' },
]
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Budapest" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Budapest transfer crosses three countries in comfort. Business visit, cultural trip, or a Danube weekend — your driver manages every border and every kilometre.</p>
          </div>
          ...
          <div className="flex flex-col gap-6 justify-start pt-[60px]">
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  { label: 'Border crossings', value: 'Czech-Slovak Schengen border near Hodonín and Slovak-Hungarian Schengen border near Rajka. No passport check for EU citizens.' },
                  ...
                  { label: 'Vienna connection', value: 'Vienna is 60 km northwest of Budapest. PRESTIGO can incorporate a Vienna stop or extend your journey onward.' },
