...
export const metadata: Metadata = {
  title: 'Prague to Düsseldorf Private Transfer — From €1,055',
  description: 'Book a private chauffeur from Prague to Düsseldorf. 640 km door-to-door in a Mercedes-Benz. Fixed price from €1,055, Rhine fashion capital.',
  alternates: { canonical: '/routes/prague-dusseldorf' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-dusseldorf',
    title: 'Prague to Düsseldorf Private Transfer — From €1,055',
    description: 'Book a private chauffeur from Prague to Düsseldorf. 640 km door-to-door in a Mercedes-Benz. Fixed price from €1,055, Rhine fashion capital.',
  },
}
...
const highlights = [
  ...
  { label: 'Price from', value: '€1,055', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,055', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,570', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,215', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Cologne or Frankfurt stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Düsseldorf transfer take?', a: 'Approximately 6.5 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A3 northwest through Frankfurt and the A3/A46 to Düsseldorf.' },
  { q: 'Is there a border crossing between Prague and Düsseldorf?', a: 'Yes. The Czech-German Schengen border is crossed at Waidhaus/Rozvadov. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Düsseldorf Airport (DUS)?', a: 'Yes. PRESTIGO serves Düsseldorf International Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What trade fairs does PRESTIGO serve in Düsseldorf?', a: 'Düsseldorf hosts MEDICA, Interpack, drupa, and the K plastics fair. PRESTIGO delivers directly to Messe Düsseldorf for any major trade event.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Düsseldorf route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Düsseldorf', item: 'https://rideprestigo.com/routes/prague-dusseldorf' },
  ],
}

export default function PragueDusseldorfPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Düsseldorf" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Düsseldorf</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Düsseldorf,<br /><span className="display-italic">Rhine fashion capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>640 km northwest to the Rhine's fashion and trade fair powerhouse. The Königsallee, Messe Düsseldorf, the Altstadt, and DUS Airport — six and a half hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Düsseldorf transfer covers the western German corridor in comfort. Trade fair, business visit, or an airport connection — your driver handles everything door to door.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Düsseldorf,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Cologne (optional)', note: 'Rhine cathedral city 45 km south of Düsseldorf — available as an en-route stop before the final stretch north.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Frankfurt, the Ruhr valley, or any stop along the western German corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Düsseldorf', note: 'Drop-off at any Düsseldorf address, Düsseldorf Airport (DUS), Messe Düsseldorf, or the Königsallee.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Airport service', value: 'Full airport meet-and-greet at Düsseldorf Airport (DUS). Flight tracking and flexible wait times included.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Düsseldorf.<br /><span className="display-italic">From €1,055, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
