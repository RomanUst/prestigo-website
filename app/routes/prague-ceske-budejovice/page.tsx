...
export const metadata: Metadata = {
  title: 'Prague to České Budějovice Private Transfer — From €255 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-ceske-budejovice',
    title: 'Prague to České Budějovice Private Transfer — From €255 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to České Budějovice. 155 km door-to-door in a Mercedes-Benz. Fixed price from €255, South Bohemia capital.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="České Budějovice" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
