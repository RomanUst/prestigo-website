      ...
      <section className="bg-anthracite py-16 md:py-20 border-b border-anthracite-light">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <p className="body-text text-[14px]" style={{ lineHeight: '1.9' }}>
            A private transfer from Prague to Warsaw is a seven-hour run across two countries, and every hour of that drive should feel like part of the trip — not a logistics problem. Prestigo runs a fleet of black Mercedes vehicles and bilingual chauffeurs who know the D1 corridor through Moravia and the Polish expressway network by heart. The price is fixed before you book. The car is waiting when you step outside your Prague address. The chauffeur already knows which entrance to use at your Warsaw hotel near Plac Trzech Krzyży or your apartment in Śródmieście.
          </p>
