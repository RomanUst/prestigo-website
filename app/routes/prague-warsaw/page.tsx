...
export const metadata: Metadata = {
  title: 'Prague to Warsaw Private Transfer — From €1,090 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-warsaw',
    title: 'Prague to Warsaw Private Transfer — From €1,090 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Warsaw. 660 km door-to-door in a Mercedes-Benz. Fixed price from €1,090, Polish capital.',
  },
}
...
const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,090', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,615', photo: '/s-class-photo.png' },
...
const inclusions = [
  ...
  'Wrocław or Łódź stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Warsaw transfer take?', a: 'Approximately 7 hours via the D1 east through Ostrava, crossing into Poland near Cieszyn, then the A1 north through Katowice and Łódź to Warsaw.' },
  { q: 'Is there a border crossing between Prague and Warsaw?', a: 'Yes. The Czech-Polish Schengen border is crossed near Ostrava/Cieszyn. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Warsaw Chopin Airport (WAW)?', a: 'Yes. PRESTIGO serves Warsaw Chopin Airport and Warsaw Modlin Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'Can I stop in Wrocław on the way?', a: 'Yes. Wrocław is on an alternative northern route and available as an en-route stop. Request at booking for optimal routing.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, Polish expressway tolls, fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Warsaw route.' },
]
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Warsaw" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Warsaw transfer crosses the Czech-Polish border and travels north through Poland in comfort. Business visit, embassy trip, or a capital weekend — your driver handles everything.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Anywhere you like', note: 'Wrocław, Łódź, or any stop along the Polish corridor. Your schedule, your pace.', anchor: false, custom: true },
                { city: 'Warsaw', note: 'Drop-off at any Warsaw address, Warsaw Chopin Airport (WAW), the Old Town, or your hotel.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Airport service', value: 'Full airport meet-and-greet at Warsaw Chopin Airport (WAW). Flight tracking and flexible wait times included.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Warsaw.<br /><span className="display-italic">From €1,090, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
