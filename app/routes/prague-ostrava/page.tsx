...
export const metadata: Metadata = {
  title: 'Prague to Ostrava Private Transfer — From €610 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-ostrava',
    title: 'Prague to Ostrava Private Transfer — From €610 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Ostrava. 370 km door-to-door in a Mercedes-Benz. Fixed price from €610, Moravian-Silesian capital.',
  },
}
...
const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €610', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €905', photo: '/s-class-photo.png' },
...
const inclusions = [
  ...
  'Olomouc stop available on request en route',
...
const faqs = [
  { q: 'How long does the Prague to Ostrava transfer take?', a: 'Approximately 4 hours via the D1 east to Brno, then the D46 and D1 northeast to Ostrava on the Polish border.' },
  { q: 'Can I stop in Olomouc on the way?', a: 'Yes. Olomouc is on the route and available as an en-route stop. Request at booking for optimal routing.' },
  { q: 'Is a same-day return available?', a: 'Yes. Your driver can wait in Ostrava or return at an agreed time. Book both directions together for a reduced rate.' },
  { q: 'What is Ostrava known for?', a: 'Ostrava is the Czech Republic\'s third city — an industrial capital reinventing itself with culture, the Colours of Ostrava music festival, and the preserved Dolní Vítkovice ironworks (a UNESCO candidate).' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Ostrava route.' },
]
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Ostrava" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Ostrava transfer runs east through Moravia and into Silesia. Business visit, festival, or an industrial heritage trip — your driver delivers you door to door.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Olomouc (optional)', note: 'Moravia\'s historic capital — available as an en-route stop for a visit or meeting.', anchor: false, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Polish connection', value: 'Ostrava is 10 km from the Polish border. PRESTIGO can extend to Katowice or Kraków as part of a single booking.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Ostrava.<br /><span className="display-italic">From €610, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
