...
export const metadata: Metadata = {
  title: 'Prague to Verona Private Transfer — From €1,370',
  description: 'Book a private chauffeur from Prague to Verona. 830 km door-to-door in a Mercedes-Benz. Fixed price from €1,370, City of Romeo and Juliet.',
  alternates: { canonical: '/routes/prague-verona' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-verona',
    title: 'Prague to Verona Private Transfer — From €1,370',
    description: 'Book a private chauffeur from Prague to Verona. 830 km door-to-door in a Mercedes-Benz. Fixed price from €1,370, City of Romeo and Juliet.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~830 km' },
  { label: 'Duration', value: '~8.5 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€1,370', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,370', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €2,035', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,575', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Innsbruck or Lake Garda stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Verona transfer take?', a: 'Approximately 8.5 hours via the D3 south through South Bohemia, crossing into Austria, the A13 through Innsbruck and the Brenner Pass into Italy, then the A22 south through Trento to Verona.' },
  { q: 'Are there border crossings between Prague and Verona?', a: 'Yes. The Czech-Austrian Schengen border in South Bohemia and the Austrian-Italian Schengen border at the Brenner Pass. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Can I stop at Lake Garda on the way?', a: 'Yes. Lake Garda is on the route and available as an en-route stop — the northern shore is 30 km west of Verona.' },
  { q: 'Does PRESTIGO serve Verona Airport (VRN)?', a: 'Yes. PRESTIGO serves Verona Villafranca Airport directly with full meet-and-greet service and flight tracking.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Verona route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Verona', item: 'https://rideprestigo.com/routes/prague-verona' },
  ],
}

export default function PragueVeronaPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Verona" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Verona</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Verona,<br /><span className="display-italic">Romeo's city.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>830 km south through Austria and over the Brenner into northern Italy. The Roman Arena, Juliet's balcony, Vinitaly wine fair, and Lake Garda minutes away — eight and a half hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Verona transfer crosses Austria over the Brenner and delivers you to the Veneto's gateway. Vinitaly, a Lake Garda holiday, or Verona Arena opera season — your driver handles everything.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Verona,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Anywhere you like', note: 'Lake Garda, Trento, or any stop in the southern Tyrol. Your route, your pace.', anchor: false, custom: true },
                { city: 'Verona', note: 'Drop-off at any Verona address, Verona Airport (VRN), the Roman Arena, or your hotel in the historic centre.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Lake Garda & Venice', value: 'Lake Garda is 30 km west of Verona. Venice is 120 km east. PRESTIGO can extend your journey from Verona to either destination.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Verona.<br /><span className="display-italic">From €1,370, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
