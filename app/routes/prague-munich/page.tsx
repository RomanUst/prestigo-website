...
export const metadata: Metadata = {
  title: 'Prague to Munich Private Transfer — From €635 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-munich',
    title: 'Prague to Munich Private Transfer — From €635 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Munich. 385 km door-to-door in a Mercedes-Benz. Fixed price from €635, Bavarian capital.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Munich" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
