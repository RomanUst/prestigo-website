...
export const metadata: Metadata = {
  title: 'Prague to Zlín Private Transfer — From €510 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-zlin',
    title: 'Prague to Zlín Private Transfer — From €510 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Zlín. 310 km door-to-door in a Mercedes-Benz. Fixed price from €510, Baťa\'s functionalist city.',
  },
}
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Zlín" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
