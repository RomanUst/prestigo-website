...
const highlights = [
  ...
  { label: 'Price from', value: '€510', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '2 bags', price: 'From €510', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '2 bags', price: 'From €760', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €590', photo: '/v-class-photo.png' },
]
...
const serviceSchema = {
  '@type': 'Service',
  '@id': 'https://rideprestigo.com/routes/prague-zlin#service',
  name: 'Private Chauffeur Transfer from Prague to Zlín',
  serviceType: 'Private ground transfer',
  description: 'Chauffeured private transfer from Prague to Zlín in Mercedes E-Class, S-Class, or V-Class. Fixed price, approximately 3 hours 30 minutes door-to-door via the D1 motorway and the D55. Distance 310 km.',
  provider: {
    '@type': 'LocalBusiness',
    ...
    itemListElement: [
      {
        ...
        url: 'https://rideprestigo.com/routes/prague-zlin#e-class',
      },
      {
        '@type': 'Offer',
        ...
        priceCurrency: 'EUR',
        availability: 'https://schema.org/InStock',
        url: 'https://rideprestigo.com/routes/prague-zlin#s-class',
      },
      {
        '@type': 'Offer',
        ...
        priceCurrency: 'EUR',
        availability: 'https://schema.org/InStock',
        url: 'https://rideprestigo.com/routes/prague-zlin#v-class',
      },
    ],
  },
}
...
const pageSchema = {
  ...
  '@graph': [
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://rideprestigo.com/routes/prague-zlin#breadcrumb',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://rideprestigo.com' },
        { '@type': 'ListItem', position: 2, name: 'Routes', item: 'https://rideprestigo.com/routes' },
        { '@type': 'ListItem', position: 3, name: 'Prague to Zlín', item: 'https://rideprestigo.com/routes/prague-zlin' },
      ],
    },
  ],
}

export default function PragueZlinPage() {
  return (
    <main id="main-content">
      ...
      <section className="bg-anthracite py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <Reveal variant="up"><div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Zlín,<br /><span className="display-italic">the route.</span></h2>
      ...
      <section className="bg-anthracite py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <Reveal variant="up"><div><h2 className="display text-[28px] md:text-[36px]">Prague to Zlín.<br /><span className="display-italic">From €510, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div></Reveal>
