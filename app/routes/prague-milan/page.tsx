...
export const metadata: Metadata = {
  title: 'Prague to Milan Private Transfer — From €1,665',
  description: 'Book a private chauffeur from Prague to Milan. 1,010 km door-to-door in a Mercedes-Benz. Fixed price from €1,665, Italian fashion capital.',
  alternates: { canonical: '/routes/prague-milan' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-milan',
    title: 'Prague to Milan Private Transfer — From €1,665',
    description: 'Book a private chauffeur from Prague to Milan. 1,010 km door-to-door in a Mercedes-Benz. Fixed price from €1,665, Italian fashion capital.',
  },
}
...
const highlights = [
  { label: 'Distance', value: '~1,010 km' },
  { label: 'Duration', value: '~10 hours' },
  { label: 'Vehicles', value: ['Business Class', 'First Class', 'Business Van'] },
  { label: 'Price from', value: '€1,665', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,665', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €2,475', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €1,920', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Innsbruck or Lake Como stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Milan transfer take?', a: 'Approximately 10 hours via the D3 south through South Bohemia, crossing into Austria, the A13 through Innsbruck and the Brenner Pass into Italy, then the A22 south and the A4 west to Milan.' },
  { q: 'Are there border crossings between Prague and Milan?', a: 'Yes. The Czech-Austrian Schengen border in South Bohemia and the Austrian-Italian Schengen border at the Brenner Pass. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Milan airports?', a: 'Yes. PRESTIGO serves both Milan Malpensa Airport (MXP) and Milan Linate Airport (LIN) directly with full meet-and-greet service and flight tracking.' },
  { q: 'Can I stop at Lake Como on the way?', a: 'Yes. Lake Como is 40 km north of Milan and available as an en-route stop or final destination. PRESTIGO can deliver you to any lakeside address.' },
  { q: 'What is included in the fixed price?', a: 'Czech motorway vignette, Austrian motorway vignette, Brenner motorway toll, Italian autostrada tolls, fuel, and driver waiting time up to 60 minutes. One price, no additions.' },
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Milan route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Milan', item: 'https://rideprestigo.com/routes/prague-milan' },
  ],
}

export default function PragueMilanPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Milan" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Milan</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Milan,<br /><span className="display-italic">Italian fashion capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>1,010 km south through Austria and over the Brenner into northern Italy. The Duomo, the Quadrilatero della Moda, Salone del Mobile, and Malpensa — ten hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Milan transfer crosses Austria over the Brenner and delivers you to Italy's commercial capital. Fashion week, Salone del Mobile, a Lake Como retreat, or Malpensa — your driver handles it all.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Milan,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Innsbruck (optional)', note: 'Tyrolean capital before the Brenner Pass — available as an en-route stop before crossing into Italy.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Lake Como, Lake Maggiore, or any stop in the Italian lakes district. Your route, your pace.', anchor: false, custom: true },
                { city: 'Milan', note: 'Drop-off at any Milan address, Malpensa Airport (MXP), Linate Airport (LIN), the Duomo, or your hotel.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Lakes & airports', value: 'PRESTIGO serves Lake Como, Lake Maggiore, Malpensa, and Linate. All Italian lake destinations can be combined with Milan in a single booking.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Milan.<br /><span className="display-italic">From €1,665, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
