...
export const metadata: Metadata = {
  title: 'Prague to Frankfurt Private Transfer — From €750',
  description: 'Book a private chauffeur from Prague to Frankfurt. 455 km door-to-door in a Mercedes-Benz. Fixed price from €750, Germany\'s financial capital.',
  alternates: { canonical: '/routes/prague-frankfurt' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-frankfurt',
    title: 'Prague to Frankfurt Private Transfer — From €750',
    description: 'Book a private chauffeur from Prague to Frankfurt. 455 km door-to-door in a Mercedes-Benz. Fixed price from €750, Germany\'s financial capital.',
  },
}
...
const highlights = [
  ...
  { label: 'Price from', value: '€750', copper: true },
]

const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €750', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €1,115', photo: '/s-class-photo.png' },
  { name: 'Mercedes-Benz V-Class', category: 'Business Van', capacity: '1–6 passengers', bags: '6 bags', price: 'From €865', photo: '/v-class-photo.png' },
]
...
const inclusions = [
  ...
  'Nuremberg or Würzburg stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Frankfurt transfer take?', a: 'Approximately 5 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6/A9 to Nuremberg and the A3 west to Frankfurt.' },
  { q: 'Is there a border crossing between Prague and Frankfurt?', a: 'Yes. The Czech-German Schengen border is crossed at Waidhaus/Rozvadov. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Frankfurt Airport (FRA)?', a: 'Yes. PRESTIGO serves Frankfurt Airport directly. Your driver will meet you at arrivals with a name board and full wait time included.' },
  { q: 'Can I stop in Nuremberg on the way?', a: 'Yes. Nuremberg is on the route and available as an en-route stop. Request at booking and your driver will plan the timing.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Frankfurt route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Frankfurt', item: 'https://rideprestigo.com/routes/prague-frankfurt' },
  ],
}

export default function PragueFrankfurtPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Frankfurt" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Frankfurt</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Frankfurt,<br /><span className="display-italic">financial capital.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>455 km southwest into Germany's banking and trade hub. The Römerberg, the ECB skyline, Frankfurt Airport, and the banking district — five hours, one fixed price, door to door.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Frankfurt transfer runs the D5 and A3 in comfort. Business meeting, trade fair, or a Frankfurt flight — your driver handles everything door to door.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Frankfurt,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Nuremberg (optional)', note: 'Franconian capital on the A9 — available as an en-route stop before continuing west to Frankfurt.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Würzburg, the Romantic Road, or any stop along the Bavarian corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Frankfurt', note: 'Drop-off at any Frankfurt address, Frankfurt Airport (FRA), or your hotel in the banking district.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Airport service', value: 'Full airport meet-and-greet at Frankfurt Airport (FRA). Flight tracking and flexible wait times included.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Frankfurt.<br /><span className="display-italic">From €750, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
