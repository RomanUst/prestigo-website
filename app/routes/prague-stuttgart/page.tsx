...
export const metadata: Metadata = {
  title: 'Prague to Stuttgart Private Transfer — From €900',
  description: 'Book a private chauffeur from Prague to Stuttgart. 545 km door-to-door in a Mercedes-Benz. Fixed price from €900, Baden-Württemberg capital.',
  alternates: { canonical: '/routes/prague-stuttgart' },
  openGraph: {
    url: 'https://rideprestigo.com/routes/prague-stuttgart',
    title: 'Prague to Stuttgart Private Transfer — From €900',
    description: 'Book a private chauffeur from Prague to Stuttgart. 545 km door-to-door in a Mercedes-Benz. Fixed price from €900, Baden-Württemberg capital.',
  },
}
...
const inclusions = [
  ...
  'Nuremberg or Heilbronn stop available on request',
...
const faqs = [
  { q: 'How long does the Prague to Stuttgart transfer take?', a: 'Approximately 5.5 hours via the D5 southwest through Plzeň, crossing into Germany at Waidhaus/Rozvadov, then the A6 to Heilbronn and the A81 south to Stuttgart.' },
  { q: 'Is there a border crossing between Prague and Stuttgart?', a: 'Yes. The Czech-German Schengen border is crossed at Waidhaus/Rozvadov. No passport check for EU citizens — non-EU passengers should carry valid travel documents.' },
  { q: 'Does PRESTIGO serve Stuttgart Airport (STR)?', a: 'Yes. PRESTIGO serves Stuttgart Airport directly with full meet-and-greet service and flight tracking.' },
  { q: 'What is Stuttgart known for?', a: 'Stuttgart is the home of Mercedes-Benz and Porsche — both with major museums in the city. Baden-Württemberg\'s capital is also a major automotive industry hub and trade fair destination.' },
  ...
  { q: 'What vehicles are available?', a: 'Mercedes-Benz E-Class, S-Class, and V-Class. All are available for the Prague–Stuttgart route.' },
]
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Prague to Stuttgart', item: 'https://rideprestigo.com/routes/prague-stuttgart' },
  ],
}

export default function PragueStuttgartPage() {
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Stuttgart" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          <p className="label mb-6">Prague → Stuttgart</p>
          <span className="copper-line mb-8 block" />
          <h1 className="display text-[40px] md:text-[56px] max-w-2xl">Prague to Stuttgart,<br /><span className="display-italic">automotive heart.</span></h1>
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>545 km southwest into Baden-Württemberg's capital. Mercedes-Benz Museum, Porsche Museum, the vine-covered Württemberg hills — five and a half hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Stuttgart transfer runs southwest through Bavaria into Baden-Württemberg. Trade fair, automotive visit, or a southern Germany trip — your driver handles everything.</p>
          </div>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <h2 className="display text-[28px] md:text-[38px] mb-6">Prague to Stuttgart,<br /><span className="display-italic">the route.</span></h2>
            <div className="flex flex-col gap-8 mt-10">
              {[
                ...
                { city: 'Nuremberg (optional)', note: 'Franconian capital on the A9 — available as an en-route stop before continuing southwest to Stuttgart.', anchor: false, custom: false },
                { city: 'Anywhere you like', note: 'Heilbronn, the Swabian Alps, or any point along the corridor. Your route, your pace.', anchor: false, custom: true },
                { city: 'Stuttgart', note: 'Drop-off at any Stuttgart address, Stuttgart Airport (STR), the Mercedes-Benz Museum, or your hotel.', anchor: true, custom: false },
            ...
            <div className="border border-anthracite-light p-8">
              ...
              <div className="flex flex-col gap-5">
                {[
                  ...
                  { label: 'Messe Stuttgart', value: 'PRESTIGO serves Stuttgart Trade Fair Centre directly. Ideal for automotive expos and industrial trade fairs.' },
      ...
      <section className="bg-anthracite py-20 border-t border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div><h2 className="display text-[28px] md:text-[36px]">Prague to Stuttgart.<br /><span className="display-italic">From €900, fixed.</span></h2><p className="body-text text-[13px] mt-4">No surprises. No meters. Your driver is waiting.</p></div>
