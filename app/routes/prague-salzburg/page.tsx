...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Prague to Salzburg Chauffeur — From €${ePrice}`,
    description: `Book a private chauffeur from Prague to Salzburg. 305 km door-to-door in a Mercedes-Benz. Fixed price from €${ePrice}, Mozart's city. Tolls and vignette included.`,
    alternates: {
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.png" alt="Salzburg — private chauffeur transfer from Prague to Salzburg" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
