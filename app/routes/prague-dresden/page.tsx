...
const inclusions = [
  ...
  'Saxon Switzerland stop available on request en route',
...
const faqs = [
  { q: 'How long does the Prague to Dresden transfer take?', a: 'Approximately 1.5 hours via the D8 motorway, crossing into Germany at Hřensko. The route is direct and scenic through the Bohemian highlands and the Elbe valley.' },
  { q: 'Is there a border crossing between Prague and Dresden?', a: 'Yes. The Czech-German border is crossed at Hřensko/Bad Schandau. Both Czech Republic and Germany are Schengen Area countries — no passport check for EU citizens. Non-EU passengers should carry valid travel documents.' },
  { q: 'Can I stop in Saxon Switzerland en route?', a: 'Yes. The Bastei rock formations and Königstein Fortress are directly on the route along the Elbe gorge. Available as a scenic en-route stop at no extra charge for a brief visit.' },
  { q: 'Is a same-day return available?', a: 'Yes. Your driver can wait in Dresden or return at an agreed time. Book both directions together for a reduced rate.' },
    ...
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          ...
          <p className="body-text text-[13px] mt-6 max-w-lg" style={{ lineHeight: '1.9' }}>150 km north on the D8 to the Florence of the North. Frauenkirche, Zwinger Palace, Semperoper, and the Elbe valley below. One and a half hours, one fixed price.</p>
      ...
      <section className="bg-anthracite py-16 md:py-24 border-b border-anthracite-light">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="body-text text-[13px]" style={{ lineHeight: '1.9' }}>PRESTIGO's Prague–Dresden transfer crosses the border in comfort. Business visit, museum day, or a weekend in Saxony — your driver handles the route while you focus on the destination.</p>
          </div>
