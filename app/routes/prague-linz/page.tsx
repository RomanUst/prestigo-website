...
export const metadata: Metadata = {
  title: 'Prague to Linz Private Transfer — From €320 | PRESTIGO',
  ...
  openGraph: {
    url: 'https://prestigo-site.vercel.app/routes/prague-linz',
    title: 'Prague to Linz Private Transfer — From €320 | PRESTIGO',
    description: 'Book a private chauffeur from Prague to Linz. 195 km door-to-door in a Mercedes-Benz. Fixed price from €320, Upper Austria capital.',
  },
}
...
const vehicles = [
  { name: 'Mercedes-Benz E-Class', category: 'Business Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €320', photo: '/e-class-photo.png' },
  { name: 'Mercedes-Benz S-Class', category: 'Executive Class', capacity: '1–3 passengers', bags: '3 bags', price: 'From €480', photo: '/s-class-photo.png' },
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><img src="/photohero.png" alt="Linz" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
