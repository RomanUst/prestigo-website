...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Prague to Wrocław Chauffeur — From €${ePrice}`,
...
export default async function PragueWroclawPage() {
  ...
  const faqs = [
    ...
    { q: 'How much does a chauffeur from Prague to Wrocław cost?', a: `A fixed fare from €${ePrice} in a Mercedes E-Class for up to 3 passengers, €${vPrice} in the V-Class for up to 6, or €${sPrice} in the S-Class. The price covers fuel, the Czech vignette, Polish motorway tolls, and driver time. No hidden charges.` },
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/photohero.jpg" alt="Wrocław — private chauffeur transfer from Prague to Wrocław" fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
