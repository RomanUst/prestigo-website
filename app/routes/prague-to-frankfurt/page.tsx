...
export default function PragueToFrankfurtPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <div className="flex flex-wrap gap-8 mt-8">
            ...
            <div>
              ...
              <p className="font-body font-light text-[14px]" style={{ color: 'var(--copper-light)' }}>€750 (E-Class)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-anthracite py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          ...
          <ul className="flex flex-col gap-4 mb-8">
            {[
              'Vehicle class. Indicative fares: from €750 in Mercedes E-Class, €975 in V-Class, or €1,125 in S-Class. Your actual quote depends on the specifics below.',
