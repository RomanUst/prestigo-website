    ...
    <main id="main-content">
      ...
      <section className="relative border-b border-anthracite-light overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0">
          <img src="/hero-contact.webp" alt="Contact PRESTIGO — Premium Chauffeur Prague" className="w-full h-full object-cover" style={{ filter: 'brightness(0.38)', objectPosition: '30% 20%' }} />
        </div>
