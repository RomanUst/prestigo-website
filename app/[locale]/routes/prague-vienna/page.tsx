...
export default async function PragueViennaPage() {
  ...
  const pageSchema = {
    ...
    '@graph': [
      ...(route
        ? buildRouteJsonLd(route, 'prague-vienna', {
            locale,
  ...
  return (
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0"><Image src="/vienna.png" alt={content.hero.imageAlt ?? 'Vienna — private chauffeur transfer from Prague to Vienna'} fill priority sizes="100vw" className="object-cover" style={{ filter: 'brightness(0.38)' }} /></div>
