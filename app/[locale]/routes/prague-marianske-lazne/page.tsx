...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const content = getRouteContent('prague-marianske-lazne', locale)
  ...
  return {
    ...
    alternates: getAlternates('/routes/prague-marianske-lazne', {
      indexable: true,
      content: { kind: 'route', key: 'prague-marianske-lazne' },
    }),
    openGraph: {
