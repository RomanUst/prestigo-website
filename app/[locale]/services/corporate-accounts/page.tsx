    ...
    <main id="main-content">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '560px' }}>
        <div className="absolute inset-0">
          <Image src="/hero-corporate-accounts.png" alt={content.hero.imageAlt} fill priority sizes="100vw" style={{ objectFit: 'cover', filter: 'brightness(0.38)' }} />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-40 pb-20">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a href={localizedHref(locale, '/corporate')} className="btn-primary">{content.hero.ctaPrimary}</a>
      ...
      <section className="bg-anthracite-mid py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          <div className="mt-10">
            <a href={localizedHref(locale, '/corporate')} className="btn-primary">{content.cta.buttonText}</a>
          </div>
        </div>
      </section>
